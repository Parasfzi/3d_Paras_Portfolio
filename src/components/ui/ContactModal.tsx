...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    href: 'www.linkedin.com/in/paras-pawar-96665b262',
    icon: (
      <svg viewBox="0 0 24 24" width="17" height="17" fill="currentColor">
        ...
        <div style={{
          ...
          >
            ...
            <div style={{ padding: '44px 48px 40px' }}>
              ...
              {/* Header */}
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '32px', paddingRight: '48px' }}>
                <div>
                  <h2 style={{
